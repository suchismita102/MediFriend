...
2. **Add Medication**: Enter medicine details along with the schedule (daily, weekly, or one-time)
3. **Track Doses**: Mark a dose as "taken" within the 30-minute window when the reminder is due
4. **View Status**: Missed doses are automatically flagged by a background cron job if not marked in time
5. **Manage Profile**: Update your personal information anytime from the profile section
